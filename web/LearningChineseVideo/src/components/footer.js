                    ...
                    <Grid
                        ...
                        <Box sx={{ width: '80%' }}>
                            ...
                            <Typography
                                ...
                                <br></br>
                                <br></br>
                                {`Các tính năng như tra từ trực tiếp trên phụ đề, linh hoạt chuyển đổi giữa các loại phụ đề, cùng tính năng lưu từ vựng sẽ giúp bạn hiểu rõ hơn và ghi nhớ từ vựng một cách hiệu quả.`}
                            </Typography>
                        </Box>
                    </Grid>
                    <Grid
